...
# Packages that this application need. Do not remove exosense since
...
SRC_URI = "git://github.com/Feuerlabs/thinkdemo.git;protocol=git;protocol=ssh;user=git"
...
#
python () {
    erlang_def_package("thinkdemo", "thinkdemo-*", "ebin priv", "src include README", d)
}
